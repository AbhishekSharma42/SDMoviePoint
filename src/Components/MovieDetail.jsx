    ...
    return (
        <>
            <div className="flex md:text-2xl flex-col justify-center items-center mt-5">
                <h2 className={`text-md font-semibold mt-2 text-center px-3 ${getMovie?.title ? "" : "h-6 md:w-[50%] bg-gray-400 rounded-xl animate-pulse"} `}>{getMovie?.title}</h2>
                ...
                <div className="flex flex-col items-center mt-5">
                    ...
                    <div className='w-full mt-4 mx-auto flex justify-center items-center gap-5'>
                        ...
                        <button className="mt-4 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">Download</button>
                    </div>
                </div>
            </div>
        </>
